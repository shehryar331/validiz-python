...
import os
import pandas as pd
from validiz import Validiz, ValidizError, ValidizAuthError, ValidizConnectionError
...
def upload_and_process_file():
    ...
    try:
        ...
        results_df = client.poll_file_until_complete(
            ...
            output_path="validation_results.csv",  # Save to file
...
def error_handling_examples():
    ...
    try:
        bad_url_client = Validiz(api_key=API_KEY, api_base_url="https://nonexistent.invalid/v1")
